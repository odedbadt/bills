...
client_id = '39331867715-sgrmts10v5a1n5ttqf6q4qknthb05vn2.apps.googleusercontent.com'

client_secret = 'AIiGeNeuAsmm29zxYe19q2ou'
  ...
  try:
    ...
    while request != None:
      ...
      for file in response.get('files', []):
        ...
        print file.get('name', 'NO NAME') + '\n'
      # Get the next request object by passing the previous request object to
      # the list_next method.
      request = service.list().list_next(request, response)
